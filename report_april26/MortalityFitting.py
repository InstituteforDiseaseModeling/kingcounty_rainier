...
if __name__ == "__main__":
    ...
    axes.fill_between(cases.index[1:], l2, h2, color="#F98866", alpha=0.8,
                      label="Transmission model fit to WDRS tests with ICs from mortality")
    ...
    axes.plot(deaths.loc[deaths.loc[deaths != 0].index[0]:],
              ...
              label="Daily King County COVID-19 deaths reported in WDRS")
