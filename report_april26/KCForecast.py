...
if __name__ == "__main__":
    ...
    axes.plot(forecast_time, cf_case_samples.mean(axis=0), lw=3, c=cf_color,
              label=r"Expectation with R$_e$ gradually increasing to mid-March levels (starting May 1)")
    axes.plot(forecast_time, op_case_samples.mean(axis=0), lw=3, c=op_color,
              label=r"Expectation with R$_e$ gradually increasing to late-March levels (starting May 1)")
    axes.plot(forecast_time, case_samples.mean(axis=0), lw=3, color=sd_color,
              label=r"Expectation with R$_e$ maintained at current levels")
